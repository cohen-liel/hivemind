...
SKILL_AGENT_MAP: dict[str, str] = {
    ...
    # New skills — web building & app development
    ...
    # Additional auto-discovered skills
    "apple-notes": "developer",
    "apple-reminders": "developer",
    "article-writing": "developer",
    "camsnap": "developer",
    "content-engine": "developer",
    "diffs": "reviewer",
    "frontend-slides": "developer",
    "gemini": "developer",
    "imsg": "developer",
    "investor-materials": "developer",
    "market-research": "orchestrator",
    "mermaid-diagrams": "developer",
    ...
    "strategic-compact": "orchestrator",
    "tdd-workflow": "tester",
