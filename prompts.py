...
_EXECUTION_FOOTER: str = (
    ...
    "</code_quality>\n\n"
    "<auto_lint>\n"
    "REQUIRED — After writing or editing any Python file, run ruff to auto-fix lint issues:\n"
    "  ruff check --fix <file_path>\n"
    "This catches syntax errors, unused imports, and style issues immediately,\n"
    "saving you from debugging trivial mistakes in later turns.\n"
