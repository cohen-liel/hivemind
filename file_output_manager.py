...
from contracts import Artifact, TaskInput, TaskOutput, TaskStatus
...
_EXT_MAP: dict[str, str] = {
    ...
    ".sql": "code", ".sh": "code", ".css": "code", ".scss": "code",
    ".html": "markup", ".xml": "markup", ".svg": "markup",
    ".json": "data", ".yaml": "data", ".yml": "data", ".toml": "data",
    ".csv": "data", ".env": "data",
    ".md": "doc", ".txt": "doc", ".rst": "doc",
    ".png": "asset", ".jpg": "asset", ".gif": "asset", ".ico": "asset",
...
class ArtifactRegistry:
    ...
    def save_manifest(self, path: str | None = None) -> str:
        ...
        for task_id, refs in self._refs.items():
            data[task_id] = [
                {"path": r.path, "type": r.file_type, "description": r.description}
                for r in refs
            ]
