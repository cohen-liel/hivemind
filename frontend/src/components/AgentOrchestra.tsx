...
export interface NexusTabContentProps {
...
// ============================================================================
// NexusTabContent — Conductor mode + DAG + self-healing
// ============================================================================

export const NexusTabContent = React.memo(function NexusTabContent({
  agentStateList,
  loopProgress,
  activities,
  totalCost,
  ...
  dagTaskStatus,
  healingEvents,
}: NexusTabContentProps): React.ReactElement {
  return (
    <>
      <ConductorMode
...
export default NexusTabContent;
