...
PM_SYSTEM_PROMPT = (
    ...
    "   - files_scope: DIRECTORY-LEVEL scope (e.g., 'backend/', 'frontend/src/components/'). Do NOT list individual files — the agent will discover the right file structure by reading the existing codebase.\n"
    ...
    "- files_scope uses directories, not individual files?\n"
